...
# Go SDK for IBM Cloud project services 0.0.8
...
The IBM Cloud project Go SDK allows developers to programmatically interact with the following IBM Cloud services:
...
[bug report](https://github.com/IBM/project-go-sdk/issues).
