...
var _ = Describe(`ProjectV1`, func() {
	...
	Describe(`CreateProject(createProjectOptions *CreateProjectOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreateProject with error: Operation response processing error`, func() {
				...
				inputVariableModel.SetProperty("foo", "testString")
				...
				projectConfigDefinitionPrototypeModel.Inputs = inputVariableModel
	...
	Describe(`CreateProjectEnvironment(createProjectEnvironmentOptions *CreateProjectEnvironmentOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreateProjectEnvironment with error: Operation response processing error`, func() {
				...
				// Construct an instance of the InputVariable model
				inputVariableModel := new(projectv1.InputVariable)
				inputVariableModel.SetProperty("resource_group", "stage")
				inputVariableModel.SetProperty("region", "us-south")
		...
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(201)
					fmt.Fprintf(res, "%s", `{"id": "ID", "project": {"id": "ID", "href": "Href", "definition": {"name": "Name"}, "crn": "crn:v1:staging:public:project:us-south:a/4e1c48fcf8ac33c0a2441e4139f189ae:bf40ad13-b107-446a-8286-c6d576183bb1::"}, "created_at": "2019-01-01T12:00:00.000Z", "target_account": "TargetAccount", "modified_at": "2019-01-01T12:00:00.000Z", "href": "Href", "definition": {"description": "Description", "name": "Name", "authorizations": {"trusted_profile_id": "TrustedProfileID", "method": "Method", "api_key": "ApiKey"}, "inputs": {}, "compliance_profile": {}}}`)
				}))
			})
		...
		Context(`Using mock server endpoint - paginated response`, func() {
			BeforeEach(func() {
				...
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					requestNumber++
					if requestNumber == 1 {
						fmt.Fprintf(res, "%s", `{"next":{"href":"https://myhost.com/somePath?token=1"},"environments":[{"id":"ID","project":{"id":"ID","href":"Href","definition":{"name":"Name"},"crn":"crn:v1:staging:public:project:us-south:a/4e1c48fcf8ac33c0a2441e4139f189ae:bf40ad13-b107-446a-8286-c6d576183bb1::"},"created_at":"2019-01-01T12:00:00.000Z","target_account":"TargetAccount","modified_at":"2019-01-01T12:00:00.000Z","href":"Href","definition":{"description":"Description","name":"Name","authorizations":{"trusted_profile_id":"TrustedProfileID","method":"Method","api_key":"ApiKey"},"inputs":{},"compliance_profile":{}}}],"total_count":2,"limit":1}`)
					} else if requestNumber == 2 {
	...
	Describe(`UpdateProjectEnvironment(updateProjectEnvironmentOptions *UpdateProjectEnvironmentOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke UpdateProjectEnvironment with error: Operation response processing error`, func() {
				...
				environmentDefinitionPropertiesPatchModel.Inputs = inputVariableModel
	...
	Describe(`CreateConfig(createConfigOptions *CreateConfigOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreateConfig with error: Operation response processing error`, func() {
				...
				// Construct an instance of the InputVariable model
				inputVariableModel := new(projectv1.InputVariable)
				inputVariableModel.SetProperty("account_id", "account_id")
				inputVariableModel.SetProperty("resource_group", "stage")
				inputVariableModel.SetProperty("access_tags", "[\"env:stage\"]")
				inputVariableModel.SetProperty("logdna_name", "LogDNA_stage_service")
				inputVariableModel.SetProperty("sysdig_name", "SysDig_stage_service")
		...
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(200)
					fmt.Fprintf(res, "%s", `{"limit": 10, "first": {"href": "Href"}, "next": {"href": "Href"}, "configs": [{"approved_version": {"definition": {"environment_id": "EnvironmentID", "locator_id": "LocatorID"}, "state": "approved", "version": 0, "href": "Href"}, "deployed_version": {"definition": {"environment_id": "EnvironmentID", "locator_id": "LocatorID"}, "state": "approved", "version": 0, "href": "Href"}, "id": "ID", "version": 0, "state": "approved", "created_at": "2019-01-01T12:00:00.000Z", "modified_at": "2019-01-01T12:00:00.000Z", "href": "Href", "definition": {"description": "Description", "name": "Name", "locator_id": "LocatorID"}, "project": {"id": "ID", "href": "Href", "definition": {"name": "Name"}, "crn": "crn:v1:staging:public:project:us-south:a/4e1c48fcf8ac33c0a2441e4139f189ae:bf40ad13-b107-446a-8286-c6d576183bb1::"}, "deployment_model": "project_deployed"}]}`)
				}))
			})
		...
		Context(`Using mock server endpoint - paginated response`, func() {
			BeforeEach(func() {
				...
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					requestNumber++
					if requestNumber == 1 {
						fmt.Fprintf(res, "%s", `{"next":{"href":"https://myhost.com/somePath?token=1"},"configs":[{"approved_version":{"definition":{"environment_id":"EnvironmentID","locator_id":"LocatorID"},"state":"approved","version":0,"href":"Href"},"deployed_version":{"definition":{"environment_id":"EnvironmentID","locator_id":"LocatorID"},"state":"approved","version":0,"href":"Href"},"id":"ID","version":0,"state":"approved","created_at":"2019-01-01T12:00:00.000Z","modified_at":"2019-01-01T12:00:00.000Z","href":"Href","definition":{"description":"Description","name":"Name","locator_id":"LocatorID"},"project":{"id":"ID","href":"Href","definition":{"name":"Name"},"crn":"crn:v1:staging:public:project:us-south:a/4e1c48fcf8ac33c0a2441e4139f189ae:bf40ad13-b107-446a-8286-c6d576183bb1::"},"deployment_model":"project_deployed"}],"total_count":2,"limit":1}`)
					} else if requestNumber == 2 {
						fmt.Fprintf(res, "%s", `{"configs":[{"approved_version":{"definition":{"environment_id":"EnvironmentID","locator_id":"LocatorID"},"state":"approved","version":0,"href":"Href"},"deployed_version":{"definition":{"environment_id":"EnvironmentID","locator_id":"LocatorID"},"state":"approved","version":0,"href":"Href"},"id":"ID","version":0,"state":"approved","created_at":"2019-01-01T12:00:00.000Z","modified_at":"2019-01-01T12:00:00.000Z","href":"Href","definition":{"description":"Description","name":"Name","locator_id":"LocatorID"},"project":{"id":"ID","href":"Href","definition":{"name":"Name"},"crn":"crn:v1:staging:public:project:us-south:a/4e1c48fcf8ac33c0a2441e4139f189ae:bf40ad13-b107-446a-8286-c6d576183bb1::"},"deployment_model":"project_deployed"}],"total_count":2,"limit":1}`)
					} else {
						res.WriteHeader(400)
					}
				}))
	...
	Describe(`UpdateConfig(updateConfigOptions *UpdateConfigOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke UpdateConfig with error: Operation response processing error`, func() {
				...
				projectConfigDefinitionPatchModel.Inputs = inputVariableModel
		...
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(200)
					fmt.Fprintf(res, "%s", `{"cost_estimate": {"version": "Version", "currency": "Currency", "totalHourlyCost": "TotalHourlyCost", "totalMonthlyCost": "TotalMonthlyCost", "pastTotalHourlyCost": "PastTotalHourlyCost", "pastTotalMonthlyCost": "PastTotalMonthlyCost", "diffTotalHourlyCost": "DiffTotalHourlyCost", "diffTotalMonthlyCost": "DiffTotalMonthlyCost", "timeGenerated": "2019-01-01T12:00:00.000Z", "user_id": "UserID"}, "cra_logs": {"cra_version": "CraVersion", "schema_version": "SchemaVersion", "status": "passed", "summary": {"total": "Total", "passed": "Passed", "failed": "Failed", "skipped": "Skipped"}, "timestamp": "2019-01-01T12:00:00.000Z"}, "job": {"id": "ID", "summary": {"version": "Version", "plan_summary": {"add": 0, "failed": 0, "update": 0, "destroy": 0, "add_resources": ["AddResources"], "failed_resources": ["FailedResources"], "updated_resources": ["UpdatedResources"], "destroy_resources": ["DestroyResources"]}, "apply_summary": {"success": 0, "failed": 0, "success_resources": ["SuccessResources"], "failed_resources": ["FailedResources"]}, "destroy_summary": {"success": 0, "failed": 0, "tainted": 0, "resources": {"success": ["Success"], "failed": ["Failed"], "tainted": ["Tainted"]}}, "message_summary": {"info": 0, "debug": 0, "error": 0}, "plan_messages": {"error_messages": [{}], "success_messages": ["SuccessMessages"], "update_messages": ["UpdateMessages"], "destroy_messages": ["DestroyMessages"]}, "apply_messages": {"error_messages": [{}], "success_messages": [{"resource_type": "ResourceType", "time-taken": "TimeTaken", "id": "ID"}]}, "destroy_messages": {"error_messages": [{}]}}}, "pre_job": {"id": "ID", "summary": {"job_id": "JobID", "start_time": "2019-01-01T12:00:00.000Z", "end_time": "2019-01-01T12:00:00.000Z", "tasks": 0, "ok": 0, "failed": 0, "skipped": 0, "changed": 0, "project_error": {"timestamp": "2019-01-01T12:00:00.000Z", "user_id": "UserID", "status_code": "StatusCode", "description": "Description", "error_response": "ErrorResponse"}}}, "post_job": {"id": "ID", "summary": {"job_id": "JobID", "start_time": "2019-01-01T12:00:00.000Z", "end_time": "2019-01-01T12:00:00.000Z", "tasks": 0, "ok": 0, "failed": 0, "skipped": 0, "changed": 0, "project_error": {"timestamp": "2019-01-01T12:00:00.000Z", "user_id": "UserID", "status_code": "StatusCode", "description": "Description", "error_response": "ErrorResponse"}}}, "result": "failed"}`)
				}))
			})
		...
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(200)
					fmt.Fprintf(res, "%s", `{"versions": [{"definition": {"environment_id": "EnvironmentID", "locator_id": "LocatorID"}, "state": "approved", "version": 0, "href": "Href"}]}`)
				}))
			})
	...
	Describe(`Model constructor tests`, func() {
		Context(`Using a service client instance`, func() {
			...
			It(`Invoke NewCreateConfigOptions successfully`, func() {
				...
				Expect(inputVariableModel.GetProperty("account_id")).To(Equal("account_id"))
				Expect(inputVariableModel.GetProperty("resource_group")).To(Equal("stage"))
				Expect(inputVariableModel.GetProperty("access_tags")).To(Equal("[\"env:stage\"]"))
				Expect(inputVariableModel.GetProperty("logdna_name")).To(Equal("LogDNA_stage_service"))
				Expect(inputVariableModel.GetProperty("sysdig_name")).To(Equal("SysDig_stage_service"))
				...
				inputVariableModelExpectedMap["account_id"] = "account_id"
				inputVariableModelExpectedMap["resource_group"] = "stage"
				inputVariableModelExpectedMap["access_tags"] = "[\"env:stage\"]"
				inputVariableModelExpectedMap["logdna_name"] = "LogDNA_stage_service"
				inputVariableModelExpectedMap["sysdig_name"] = "SysDig_stage_service"
				...
				Expect(projectConfigDefinitionPrototypeModel.Inputs).To(Equal(inputVariableModel))
			...
			It(`Invoke NewCreateProjectEnvironmentOptions successfully`, func() {
				...
				Expect(inputVariableModel.GetProperties()).ToNot(BeEmpty())
				Expect(inputVariableModel.GetProperty("resource_group")).To(Equal("stage"))
				Expect(inputVariableModel.GetProperty("region")).To(Equal("us-south"))
				...
				inputVariableModelExpectedMap := make(map[string]interface{})
				inputVariableModelExpectedMap["resource_group"] = "stage"
				inputVariableModelExpectedMap["region"] = "us-south"
				inputVariableModel.SetProperties(inputVariableModelExpectedMap)
				inputVariableModelActualMap := inputVariableModel.GetProperties()
				Expect(inputVariableModelActualMap).To(Equal(inputVariableModelExpectedMap))
			...
			It(`Invoke NewCreateProjectOptions successfully`, func() {
				...
				inputVariableModel.SetProperty("foo", "testString")
				Expect(inputVariableModel.GetProperties()).ToNot(BeEmpty())
				Expect(inputVariableModel.GetProperty("foo")).To(Equal("testString"))

				inputVariableModel.SetProperties(nil)
				Expect(inputVariableModel.GetProperties()).To(BeEmpty())

				inputVariableModelExpectedMap := make(map[string]interface{})
				inputVariableModelExpectedMap["foo"] = "testString"
				inputVariableModel.SetProperties(inputVariableModelExpectedMap)
				inputVariableModelActualMap := inputVariableModel.GetProperties()
				Expect(inputVariableModelActualMap).To(Equal(inputVariableModelExpectedMap))
			...
			It(`Invoke NewUpdateConfigOptions successfully`, func() {
				...
				Expect(projectConfigDefinitionPatchModel.Inputs).To(Equal(inputVariableModel))
			...
			It(`Invoke NewUpdateProjectEnvironmentOptions successfully`, func() {
				...
				Expect(environmentDefinitionPropertiesPatchModel.Inputs).To(Equal(inputVariableModel))
	...
	Describe(`Model unmarshaling tests`, func() {
		...
		It(`Invoke UnmarshalInputVariable successfully`, func() {
			// Construct an instance of the model.
			model := new(projectv1.InputVariable)
			...
			var result *projectv1.InputVariable
			err = projectv1.UnmarshalInputVariable(raw, &result)
			Expect(err).To(BeNil())
			Expect(result).ToNot(BeNil())
			Expect(result).To(Equal(model))
		})
