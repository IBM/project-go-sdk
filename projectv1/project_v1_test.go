	...
	Describe(`CreateProject(createProjectOptions *CreateProjectOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreateProject with error: Operation response processing error`, func() {
				...
				projectConfigModel.Definition = projectConfigDefinitionPropModel
	...
	Describe(`CreateConfig(createConfigOptions *CreateConfigOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreateConfig with error: Operation response processing error`, func() {
				...
				createConfigOptionsModel.Definition = projectConfigPrototypeDefinitionGraphFragmentDefinitionModel
	...
	Describe(`UpdateConfig(updateConfigOptions *UpdateConfigOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke UpdateConfig with error: Operation response processing error`, func() {
				...
				updateConfigOptionsModel.Definition = projectConfigPrototypeDefinitionGraphFragmentDefinitionModel
	...
	Describe(`Model constructor tests`, func() {
		Context(`Using a service client instance`, func() {
			...
			It(`Invoke NewCreateConfigOptions successfully`, func() {
				...
				createConfigOptionsModel.SetDefinition(projectConfigPrototypeDefinitionGraphFragmentDefinitionModel)
				...
				Expect(createConfigOptionsModel.Definition).To(Equal(projectConfigPrototypeDefinitionGraphFragmentDefinitionModel))
			...
			It(`Invoke NewCreateProjectOptions successfully`, func() {
				...
				projectConfigModel.Definition = projectConfigDefinitionPropModel
				Expect(projectConfigModel.Definition).To(Equal(projectConfigDefinitionPropModel))
			...
			It(`Invoke NewProjectConfigDefinitionProp successfully`, func() {
				name := "testString"
				locatorID := "testString"
				_model, err := projectService.NewProjectConfigDefinitionProp(name, locatorID)
			...
			It(`Invoke NewUpdateConfigOptions successfully`, func() {
				...
				updateConfigOptionsModel.SetDefinition(projectConfigPrototypeDefinitionGraphFragmentDefinitionModel)
				...
				Expect(updateConfigOptionsModel.Definition).To(Equal(projectConfigPrototypeDefinitionGraphFragmentDefinitionModel))
