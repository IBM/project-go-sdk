	...
	Describe(`CreateProject(createProjectOptions *CreateProjectOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreateProject with error: Operation response processing error`, func() {
				...
				projectConfigPrototypeDefinitionBlockModel.Inputs = map[string]string{"key1": "testString"}
				projectConfigPrototypeDefinitionBlockModel.Settings = map[string]string{"key1": "testString"}
	...
	Describe(`CreateProjectEnvironment(createProjectEnvironmentOptions *CreateProjectEnvironmentOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreateProjectEnvironment with error: Operation response processing error`, func() {
				...
				environmentDefinitionRequiredPropertiesModel.Inputs = map[string]string{"key1": "testString"}
		...
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(201)
					fmt.Fprintf(res, "%s", `{"id": "ID", "project": {"id": "ID", "definition": {"name": "Name"}, "crn": "crn:v1:staging:public:project:us-south:a/4e1c48fcf8ac33c0a2441e4139f189ae:bf40ad13-b107-446a-8286-c6d576183bb1::", "href": "Href"}, "created_at": "2019-01-01T12:00:00.000Z", "target_account": "TargetAccount", "modified_at": "2019-01-01T12:00:00.000Z", "definition": {"name": "Name", "description": "Description", "authorizations": {"trusted_profile_id": "TrustedProfileID", "method": "api_key", "api_key": "ApiKey"}, "inputs": {"mapKey": "Inner"}, "compliance_profile": {"id": "ID", "instance_id": "InstanceID", "instance_location": "InstanceLocation", "attachment_id": "AttachmentID", "profile_name": "ProfileName"}}}`)
				}))
			})
	...
	Describe(`UpdateProjectEnvironment(updateProjectEnvironmentOptions *UpdateProjectEnvironmentOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke UpdateProjectEnvironment with error: Operation response processing error`, func() {
				...
				environmentDefinitionPropertiesModel.Inputs = map[string]string{"key1": "testString"}
	...
	Describe(`UpdateConfig(updateConfigOptions *UpdateConfigOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke UpdateConfig with error: Operation response processing error`, func() {
				...
				// Construct an instance of the ProjectConfigPatchDefinitionBlock model
				projectConfigPatchDefinitionBlockModel := new(projectv1.ProjectConfigPatchDefinitionBlock)
				...
				projectConfigPatchDefinitionBlockModel.Inputs = map[string]string{"key1": "testString"}
				projectConfigPatchDefinitionBlockModel.Settings = map[string]string{"key1": "testString"}
	...
	Describe(`Model constructor tests`, func() {
		Context(`Using a service client instance`, func() {
			...
			It(`Invoke NewCreateConfigOptions successfully`, func() {
				...
				Expect(projectConfigPrototypeDefinitionBlockModel.Inputs).To(Equal(map[string]string{"key1": "testString"}))
				Expect(projectConfigPrototypeDefinitionBlockModel.Settings).To(Equal(map[string]string{"key1": "testString"}))
			...
			It(`Invoke NewCreateProjectEnvironmentOptions successfully`, func() {
				...
				Expect(environmentDefinitionRequiredPropertiesModel.Inputs).To(Equal(map[string]string{"key1": "testString"}))
			...
			It(`Invoke NewUpdateConfigOptions successfully`, func() {
				...
				Expect(projectConfigPatchDefinitionBlockModel.Inputs).To(Equal(map[string]string{"key1": "testString"}))
				Expect(projectConfigPatchDefinitionBlockModel.Settings).To(Equal(map[string]string{"key1": "testString"}))

				// Construct an instance of the UpdateConfigOptions model
				projectID := "testString"
				id := "testString"
				var updateConfigOptionsDefinition *projectv1.ProjectConfigPatchDefinitionBlock = nil
			...
			It(`Invoke NewUpdateProjectEnvironmentOptions successfully`, func() {
				...
				Expect(environmentDefinitionPropertiesModel.Inputs).To(Equal(map[string]string{"key1": "testString"}))
