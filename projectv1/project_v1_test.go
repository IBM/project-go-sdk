	...
	Describe(`CreateProject(createProjectOptions *CreateProjectOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreateProject with error: Operation response processing error`, func() {
				...
				// Construct an instance of the ProjectConfigPrototypeDefinitionBlockDAConfigDefinitionProperties model
				projectConfigPrototypeDefinitionBlockModel := new(projectv1.ProjectConfigPrototypeDefinitionBlockDAConfigDefinitionProperties)
				...
				projectConfigPrototypeDefinitionBlockModel.EnvironmentID = core.StringPtr("testString")
				projectConfigPrototypeDefinitionBlockModel.Authorizations = projectConfigAuthModel
				projectConfigPrototypeDefinitionBlockModel.Inputs = map[string]interface{}{"anyKey": "anyValue"}
				projectConfigPrototypeDefinitionBlockModel.Settings = map[string]interface{}{"anyKey": "anyValue"}
		...
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(201)
					fmt.Fprintf(res, "%s", `{"id": "ID", "project": {"id": "ID", "definition": {"name": "Name"}, "crn": "crn:v1:staging:public:project:us-south:a/4e1c48fcf8ac33c0a2441e4139f189ae:bf40ad13-b107-446a-8286-c6d576183bb1::", "href": "Href"}, "created_at": "2019-01-01T12:00:00.000Z", "target_account": "TargetAccount", "modified_at": "2019-01-01T12:00:00.000Z", "href": "Href", "definition": {"name": "Name", "description": "Description", "authorizations": {"trusted_profile_id": "TrustedProfileID", "method": "api_key", "api_key": "ApiKey"}, "inputs": {"anyKey": "anyValue"}, "compliance_profile": {"id": "ID", "instance_id": "InstanceID", "instance_location": "InstanceLocation", "attachment_id": "AttachmentID", "profile_name": "ProfileName"}}}`)
				}))
			})
	...
	Describe(`UpdateProjectEnvironment(updateProjectEnvironmentOptions *UpdateProjectEnvironmentOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke UpdateProjectEnvironment with error: Operation response processing error`, func() {
				...
				environmentDefinitionPropertiesModel.Inputs = map[string]interface{}{"anyKey": "anyValue"}
	...
	Describe(`CreateConfig(createConfigOptions *CreateConfigOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreateConfig with error: Operation response processing error`, func() {
				...
				projectConfigPrototypeDefinitionBlockModel.Description = core.StringPtr("Stage environment configuration.")
				projectConfigPrototypeDefinitionBlockModel.EnvironmentID = core.StringPtr("testString")
				projectConfigPrototypeDefinitionBlockModel.Authorizations = projectConfigAuthModel
				projectConfigPrototypeDefinitionBlockModel.Inputs = map[string]interface{}{"anyKey": "anyValue"}
				projectConfigPrototypeDefinitionBlockModel.Settings = map[string]interface{}{"anyKey": "anyValue"}
		...
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(200)
					fmt.Fprintf(res, "%s", `{"configs": [{"approved_version": {"state": "approved", "version": 7, "href": "Href"}, "deployed_version": {"state": "approved", "version": 7, "href": "Href"}, "id": "ID", "version": 7, "state": "approved", "created_at": "2019-01-01T12:00:00.000Z", "modified_at": "2019-01-01T12:00:00.000Z", "href": "Href", "definition": {"name": "Name", "description": "Description"}, "project": {"id": "ID", "definition": {"name": "Name"}, "crn": "crn:v1:staging:public:project:us-south:a/4e1c48fcf8ac33c0a2441e4139f189ae:bf40ad13-b107-446a-8286-c6d576183bb1::", "href": "Href"}, "deployment_model": "project_deployed"}]}`)
				}))
			})
	...
	Describe(`UpdateConfig(updateConfigOptions *UpdateConfigOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke UpdateConfig with error: Operation response processing error`, func() {
				...
				// Construct an instance of the ProjectConfigPatchDefinitionBlockDAConfigDefinitionProperties model
				projectConfigPatchDefinitionBlockModel := new(projectv1.ProjectConfigPatchDefinitionBlockDAConfigDefinitionProperties)
				projectConfigPatchDefinitionBlockModel.Name = core.StringPtr("env-stage")
				projectConfigPatchDefinitionBlockModel.Description = core.StringPtr("testString")
				projectConfigPatchDefinitionBlockModel.EnvironmentID = core.StringPtr("testString")
				projectConfigPatchDefinitionBlockModel.Authorizations = projectConfigAuthModel
				projectConfigPatchDefinitionBlockModel.Inputs = map[string]interface{}{"anyKey": "anyValue"}
				projectConfigPatchDefinitionBlockModel.Settings = map[string]interface{}{"anyKey": "anyValue"}
				projectConfigPatchDefinitionBlockModel.ComplianceProfile = projectComplianceProfileModel
				projectConfigPatchDefinitionBlockModel.LocatorID = core.StringPtr("testString")
				...
				updateConfigOptionsModel.Definition = projectConfigPatchDefinitionBlockModel
	...
	Describe(`Model constructor tests`, func() {
		Context(`Using a service client instance`, func() {
			...
			It(`Invoke NewCreateConfigOptions successfully`, func() {
				...
				Expect(projectConfigPrototypeDefinitionBlockModel.Description).To(Equal(core.StringPtr("Stage environment configuration.")))
				Expect(projectConfigPrototypeDefinitionBlockModel.EnvironmentID).To(Equal(core.StringPtr("testString")))
				Expect(projectConfigPrototypeDefinitionBlockModel.Authorizations).To(Equal(projectConfigAuthModel))
				Expect(projectConfigPrototypeDefinitionBlockModel.Inputs).To(Equal(map[string]interface{}{"anyKey": "anyValue"}))
				Expect(projectConfigPrototypeDefinitionBlockModel.Settings).To(Equal(map[string]interface{}{"anyKey": "anyValue"}))
				...
				// Construct an instance of the CreateConfigOptions model
				projectID := "testString"
				var createConfigOptionsDefinition projectv1.ProjectConfigPrototypeDefinitionBlockIntf = nil
			...
			It(`Invoke NewProjectConfigPrototype successfully`, func() {
				var definition projectv1.ProjectConfigPrototypeDefinitionBlockIntf = nil
			...
			It(`Invoke NewUpdateConfigOptions successfully`, func() {
				...
				// Construct an instance of the ProjectConfigPatchDefinitionBlockDAConfigDefinitionProperties model
				projectConfigPatchDefinitionBlockModel := new(projectv1.ProjectConfigPatchDefinitionBlockDAConfigDefinitionProperties)
				Expect(projectConfigPatchDefinitionBlockModel).ToNot(BeNil())
				projectConfigPatchDefinitionBlockModel.Name = core.StringPtr("env-stage")
				projectConfigPatchDefinitionBlockModel.Description = core.StringPtr("testString")
				projectConfigPatchDefinitionBlockModel.EnvironmentID = core.StringPtr("testString")
				projectConfigPatchDefinitionBlockModel.Authorizations = projectConfigAuthModel
				...
				projectConfigPatchDefinitionBlockModel.ComplianceProfile = projectComplianceProfileModel
				projectConfigPatchDefinitionBlockModel.LocatorID = core.StringPtr("testString")
				Expect(projectConfigPatchDefinitionBlockModel.Name).To(Equal(core.StringPtr("env-stage")))
				Expect(projectConfigPatchDefinitionBlockModel.Description).To(Equal(core.StringPtr("testString")))
				Expect(projectConfigPatchDefinitionBlockModel.EnvironmentID).To(Equal(core.StringPtr("testString")))
				Expect(projectConfigPatchDefinitionBlockModel.Authorizations).To(Equal(projectConfigAuthModel))
				Expect(projectConfigPatchDefinitionBlockModel.Inputs).To(Equal(map[string]interface{}{"anyKey": "anyValue"}))
				Expect(projectConfigPatchDefinitionBlockModel.Settings).To(Equal(map[string]interface{}{"anyKey": "anyValue"}))
				Expect(projectConfigPatchDefinitionBlockModel.ComplianceProfile).To(Equal(projectComplianceProfileModel))
				Expect(projectConfigPatchDefinitionBlockModel.LocatorID).To(Equal(core.StringPtr("testString")))

				// Construct an instance of the UpdateConfigOptions model
				projectID := "testString"
				id := "testString"
				var updateConfigOptionsDefinition projectv1.ProjectConfigPatchDefinitionBlockIntf = nil
				...
				updateConfigOptionsModel.SetDefinition(projectConfigPatchDefinitionBlockModel)
				...
				Expect(updateConfigOptionsModel.Definition).To(Equal(projectConfigPatchDefinitionBlockModel))
			...
			It(`Invoke NewUpdateProjectEnvironmentOptions successfully`, func() {
				...
				Expect(environmentDefinitionPropertiesModel.Inputs).To(Equal(map[string]interface{}{"anyKey": "anyValue"}))
