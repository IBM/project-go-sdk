		...
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(200)
					fmt.Fprintf(res, "%s", `{"configs": [{"approved_version": {"state": "approved", "version": 7, "href": "Href"}, "deployed_version": {"state": "approved", "version": 7, "href": "Href"}, "id": "ID", "project_id": "ProjectID", "version": 7, "state": "approved", "created_at": "2019-01-01T12:00:00.000Z", "user_modified_at": "2019-01-01T12:00:00.000Z", "href": "Href", "definition": {"name": "Name", "description": "Description"}}]}`)
				}))
			})
