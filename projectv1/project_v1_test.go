	...
	Describe(`CreateProject(createProjectOptions *CreateProjectOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreateProject with error: Operation response processing error`, func() {
				...
				projectPrototypeDefinitionModel.MonitoringEnabled = core.BoolPtr(true)
				...
				projectConfigDefinitionBlockPrototypeModel.LocatorID = core.StringPtr("testString")
				projectConfigDefinitionBlockPrototypeModel.Description = core.StringPtr("testString")
				projectConfigDefinitionBlockPrototypeModel.Name = core.StringPtr("testString")
	...
	Describe(`CreateConfig(createConfigOptions *CreateConfigOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreateConfig with error: Operation response processing error`, func() {
				...
				projectConfigDefinitionBlockPrototypeModel.Description = core.StringPtr("Stage environment configuration.")
		...
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(200)
					fmt.Fprintf(res, "%s", `{"limit": 10, "first": {"href": "Href"}, "next": {"href": "Href"}, "configs": [{"approved_version": {"state": "approved", "version": 7, "href": "Href"}, "deployed_version": {"state": "approved", "version": 7, "href": "Href"}, "id": "ID", "version": 7, "state": "approved", "created_at": "2019-01-01T12:00:00.000Z", "modified_at": "2019-01-01T12:00:00.000Z", "href": "Href", "definition": {"description": "Description", "name": "Name"}, "project": {"id": "ID", "definition": {"name": "Name"}, "crn": "crn:v1:staging:public:project:us-south:a/4e1c48fcf8ac33c0a2441e4139f189ae:bf40ad13-b107-446a-8286-c6d576183bb1::", "href": "Href"}, "deployment_model": "project_deployed"}]}`)
				}))
			})
		...
		Context(`Using mock server endpoint - paginated response`, func() {
			BeforeEach(func() {
				...
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					requestNumber++
					if requestNumber == 1 {
						fmt.Fprintf(res, "%s", `{"next":{"href":"https://myhost.com/somePath?start=1"},"configs":[{"approved_version":{"state":"approved","version":7,"href":"Href"},"deployed_version":{"state":"approved","version":7,"href":"Href"},"id":"ID","version":7,"state":"approved","created_at":"2019-01-01T12:00:00.000Z","modified_at":"2019-01-01T12:00:00.000Z","href":"Href","definition":{"description":"Description","name":"Name"},"project":{"id":"ID","definition":{"name":"Name"},"crn":"crn:v1:staging:public:project:us-south:a/4e1c48fcf8ac33c0a2441e4139f189ae:bf40ad13-b107-446a-8286-c6d576183bb1::","href":"Href"},"deployment_model":"project_deployed"}],"total_count":2,"limit":1}`)
					} else if requestNumber == 2 {
	...
	Describe(`Model constructor tests`, func() {
		Context(`Using a service client instance`, func() {
			...
			It(`Invoke NewCreateConfigOptions successfully`, func() {
				...
				Expect(projectConfigDefinitionBlockPrototypeModel.Description).To(Equal(core.StringPtr("Stage environment configuration.")))
			...
			It(`Invoke NewCreateProjectOptions successfully`, func() {
				...
				Expect(projectPrototypeDefinitionModel.MonitoringEnabled).To(Equal(core.BoolPtr(true)))
				...
				projectConfigDefinitionBlockPrototypeModel.Settings = map[string]interface{}{"anyKey": "anyValue"}
				Expect(projectConfigDefinitionBlockPrototypeModel.ComplianceProfile).To(Equal(projectComplianceProfileModel))
				Expect(projectConfigDefinitionBlockPrototypeModel.LocatorID).To(Equal(core.StringPtr("testString")))
				Expect(projectConfigDefinitionBlockPrototypeModel.Description).To(Equal(core.StringPtr("testString")))
				Expect(projectConfigDefinitionBlockPrototypeModel.Name).To(Equal(core.StringPtr("testString")))
				Expect(projectConfigDefinitionBlockPrototypeModel.EnvironmentID).To(Equal(core.StringPtr("testString")))
				Expect(projectConfigDefinitionBlockPrototypeModel.Authorizations).To(Equal(projectConfigAuthModel))
				Expect(projectConfigDefinitionBlockPrototypeModel.Inputs).To(Equal(map[string]interface{}{"anyKey": "anyValue"}))
				Expect(projectConfigDefinitionBlockPrototypeModel.Settings).To(Equal(map[string]interface{}{"anyKey": "anyValue"}))
