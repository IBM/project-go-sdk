...
// GetCheckJobLog : View the latest check job log
// Fetch the latest check job log and status.
func (project *ProjectV1) GetCheckJobLog(getCheckJobLogOptions *GetCheckJobLogOptions) (result *ActionJobLog, response *core.DetailedResponse, err error) {
	return project.GetCheckJobLogWithContext(context.Background(), getCheckJobLogOptions)
}

// GetCheckJobLogWithContext is an alternate form of the GetCheckJobLog method which supports a Context parameter
func (project *ProjectV1) GetCheckJobLogWithContext(ctx context.Context, getCheckJobLogOptions *GetCheckJobLogOptions) (result *ActionJobLog, response *core.DetailedResponse, err error) {
	err = core.ValidateNotNil(getCheckJobLogOptions, "getCheckJobLogOptions cannot be nil")
	if err != nil {
		return
	}
	err = core.ValidateStruct(getCheckJobLogOptions, "getCheckJobLogOptions")
	if err != nil {
		return
	}

	pathParamsMap := map[string]string{
		"project_id": *getCheckJobLogOptions.ProjectID,
		"id":         *getCheckJobLogOptions.ID,
	}

	builder := core.NewRequestBuilder(core.GET)
	builder = builder.WithContext(ctx)
	builder.EnableGzipCompression = project.GetEnableGzipCompression()
	_, err = builder.ResolveRequestURL(project.Service.Options.URL, `/v1/projects/{project_id}/configs/{id}/check_job_log`, pathParamsMap)
	if err != nil {
		return
	}

	for headerName, headerValue := range getCheckJobLogOptions.Headers {
		builder.AddHeader(headerName, headerValue)
	}

	sdkHeaders := common.GetSdkHeaders("project", "V1", "GetCheckJobLog")
	for headerName, headerValue := range sdkHeaders {
		builder.AddHeader(headerName, headerValue)
	}
	builder.AddHeader("Accept", "application/json")

	if getCheckJobLogOptions.IsDraft != nil {
		builder.AddQuery("is_draft", fmt.Sprint(*getCheckJobLogOptions.IsDraft))
	}
	...
	if rawResponse != nil {
		err = core.UnmarshalModel(rawResponse, "", &result, UnmarshalActionJobLog)
		if err != nil {
			return
		}
		response.Result = result
...
// GetInstallJobLog : View the latest install job log
// Fetch the latest install job log and status.
func (project *ProjectV1) GetInstallJobLog(getInstallJobLogOptions *GetInstallJobLogOptions) (result *ActionJobLog, response *core.DetailedResponse, err error) {
	return project.GetInstallJobLogWithContext(context.Background(), getInstallJobLogOptions)
}

// GetInstallJobLogWithContext is an alternate form of the GetInstallJobLog method which supports a Context parameter
func (project *ProjectV1) GetInstallJobLogWithContext(ctx context.Context, getInstallJobLogOptions *GetInstallJobLogOptions) (result *ActionJobLog, response *core.DetailedResponse, err error) {
	err = core.ValidateNotNil(getInstallJobLogOptions, "getInstallJobLogOptions cannot be nil")
	if err != nil {
		return
	}
	err = core.ValidateStruct(getInstallJobLogOptions, "getInstallJobLogOptions")
	if err != nil {
		return
	}

	pathParamsMap := map[string]string{
		"project_id": *getInstallJobLogOptions.ProjectID,
		"id":         *getInstallJobLogOptions.ID,
	}

	builder := core.NewRequestBuilder(core.GET)
	builder = builder.WithContext(ctx)
	builder.EnableGzipCompression = project.GetEnableGzipCompression()
	_, err = builder.ResolveRequestURL(project.Service.Options.URL, `/v1/projects/{project_id}/configs/{id}/install_job_log`, pathParamsMap)
	if err != nil {
		return
	}

	for headerName, headerValue := range getInstallJobLogOptions.Headers {
		builder.AddHeader(headerName, headerValue)
	}

	sdkHeaders := common.GetSdkHeaders("project", "V1", "GetInstallJobLog")
	for headerName, headerValue := range sdkHeaders {
		builder.AddHeader(headerName, headerValue)
	}
	builder.AddHeader("Accept", "application/json")
...
// GetUninstallJobLog : View the latest uninstall job log
// Fetch the latest uninstall job log and status.
func (project *ProjectV1) GetUninstallJobLog(getUninstallJobLogOptions *GetUninstallJobLogOptions) (result *ActionJobLog, response *core.DetailedResponse, err error) {
	return project.GetUninstallJobLogWithContext(context.Background(), getUninstallJobLogOptions)
}

// GetUninstallJobLogWithContext is an alternate form of the GetUninstallJobLog method which supports a Context parameter
func (project *ProjectV1) GetUninstallJobLogWithContext(ctx context.Context, getUninstallJobLogOptions *GetUninstallJobLogOptions) (result *ActionJobLog, response *core.DetailedResponse, err error) {
	err = core.ValidateNotNil(getUninstallJobLogOptions, "getUninstallJobLogOptions cannot be nil")
	if err != nil {
		return
	}
	err = core.ValidateStruct(getUninstallJobLogOptions, "getUninstallJobLogOptions")
	if err != nil {
		return
	}

	pathParamsMap := map[string]string{
		"project_id": *getUninstallJobLogOptions.ProjectID,
		"id":         *getUninstallJobLogOptions.ID,
	}

	builder := core.NewRequestBuilder(core.GET)
	builder = builder.WithContext(ctx)
	builder.EnableGzipCompression = project.GetEnableGzipCompression()
	_, err = builder.ResolveRequestURL(project.Service.Options.URL, `/v1/projects/{project_id}/configs/{id}/uninstall_job_log`, pathParamsMap)
	if err != nil {
		return
	}

	for headerName, headerValue := range getUninstallJobLogOptions.Headers {
		builder.AddHeader(headerName, headerValue)
	}

	sdkHeaders := common.GetSdkHeaders("project", "V1", "GetUninstallJobLog")
	for headerName, headerValue := range sdkHeaders {
		builder.AddHeader(headerName, headerValue)
	}
	builder.AddHeader("Accept", "application/json")
...
// ActionJobLog : The response of fetching an action job log.
type ActionJobLog struct {
	// Job log in plain text format.
...
// UnmarshalActionJobLog unmarshals an instance of ActionJobLog from the specified map of raw messages.
func UnmarshalActionJobLog(m map[string]json.RawMessage, result interface{}) (err error) {
	obj := new(ActionJobLog)
...
// GetCheckJobLogOptions : The GetCheckJobLog options.
type GetCheckJobLogOptions struct {
	// The unique project ID.
	ProjectID *string `json:"project_id" validate:"required,ne="`
	...
	// Specifies whether the check job log is pulled for the `draft` or the `active` version of the configuration.
	IsDraft *bool `json:"is_draft,omitempty"`
...
// NewGetCheckJobLogOptions : Instantiate GetCheckJobLogOptions
func (*ProjectV1) NewGetCheckJobLogOptions(projectID string, id string) *GetCheckJobLogOptions {
	return &GetCheckJobLogOptions{
		ProjectID: core.StringPtr(projectID),
		ID:        core.StringPtr(id),
	}
}
...
// SetProjectID : Allow user to set ProjectID
func (_options *GetCheckJobLogOptions) SetProjectID(projectID string) *GetCheckJobLogOptions {
	_options.ProjectID = core.StringPtr(projectID)
	return _options
}

// SetID : Allow user to set ID
func (_options *GetCheckJobLogOptions) SetID(id string) *GetCheckJobLogOptions {
	_options.ID = core.StringPtr(id)
	return _options
}

// SetIsDraft : Allow user to set IsDraft
func (_options *GetCheckJobLogOptions) SetIsDraft(isDraft bool) *GetCheckJobLogOptions {
	_options.IsDraft = core.BoolPtr(isDraft)
	return _options
}

// SetHeaders : Allow user to set Headers
func (options *GetCheckJobLogOptions) SetHeaders(param map[string]string) *GetCheckJobLogOptions {
	options.Headers = param
	return options
}
...
// GetInstallJobLogOptions : The GetInstallJobLog options.
type GetInstallJobLogOptions struct {
	// The unique project ID.
	ProjectID *string `json:"project_id" validate:"required,ne="`
...
// NewGetInstallJobLogOptions : Instantiate GetInstallJobLogOptions
func (*ProjectV1) NewGetInstallJobLogOptions(projectID string, id string) *GetInstallJobLogOptions {
	return &GetInstallJobLogOptions{
		ProjectID: core.StringPtr(projectID),
		ID:        core.StringPtr(id),
	}
}
...
// SetProjectID : Allow user to set ProjectID
func (_options *GetInstallJobLogOptions) SetProjectID(projectID string) *GetInstallJobLogOptions {
	_options.ProjectID = core.StringPtr(projectID)
	return _options
}

// SetID : Allow user to set ID
func (_options *GetInstallJobLogOptions) SetID(id string) *GetInstallJobLogOptions {
	_options.ID = core.StringPtr(id)
	return _options
}

// SetHeaders : Allow user to set Headers
func (options *GetInstallJobLogOptions) SetHeaders(param map[string]string) *GetInstallJobLogOptions {
	options.Headers = param
	return options
}
...
// GetUninstallJobLogOptions : The GetUninstallJobLog options.
type GetUninstallJobLogOptions struct {
	// The unique project ID.
	ProjectID *string `json:"project_id" validate:"required,ne="`
...
// NewGetUninstallJobLogOptions : Instantiate GetUninstallJobLogOptions
func (*ProjectV1) NewGetUninstallJobLogOptions(projectID string, id string) *GetUninstallJobLogOptions {
	return &GetUninstallJobLogOptions{
		ProjectID: core.StringPtr(projectID),
		ID:        core.StringPtr(id),
	}
}
...
// SetProjectID : Allow user to set ProjectID
func (_options *GetUninstallJobLogOptions) SetProjectID(projectID string) *GetUninstallJobLogOptions {
	_options.ProjectID = core.StringPtr(projectID)
	return _options
}

// SetID : Allow user to set ID
func (_options *GetUninstallJobLogOptions) SetID(id string) *GetUninstallJobLogOptions {
	_options.ID = core.StringPtr(id)
	return _options
}

// SetHeaders : Allow user to set Headers
func (options *GetUninstallJobLogOptions) SetHeaders(param map[string]string) *GetUninstallJobLogOptions {
	options.Headers = param
	return options
}
...
func UnmarshalProjectConfigCollectionMember(m map[string]json.RawMessage, result interface{}) (err error) {
	...
	err = core.UnmarshalModel(m, "active_draft", &obj.ActiveDraft, UnmarshalProjectConfigDraftSummary)
	if err != nil {
		return
	}
